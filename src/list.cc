...
cdada_list_t* __cdada_list_create(const uint16_t val_size,
	...
	cdada_list_t *result = (cdada_list_t *)m;
...
int cdada_list_insert(cdada_list_t* list, const void* val, const uint32_t pos){
	...
	try{
		...
		switch(c){
			...
			case 0:
				CDADA_ASSERT(m->ops);
				return (*m->ops->insert)(list, val, pos);
			default:
				break;
		}
	}catch(bad_alloc& e){
...
int cdada_list_get(const cdada_list_t* list, const uint32_t pos, void* val){
	...
	try{
		...
		switch(c){
			case 1:
				return cdada_list_get_u<uint8_t>(m,
								m->list.u8,
								pos, val);
			case 2:
		...
		switch(c){
			...
			case 256:
				return cdada_list_first_last_u<cdada_u2048_t>(m,
								...
								first, key);
			case 0:
				return (*m->ops->first_last)(list, first, key);
			default:
				break;
		}
	}catch(...){}
...
static int cdada_list_push_(cdada_list_t* list, const void* val, bool front){
	...
	try{
		...
		switch(c){
			case 1:
				return cdada_list_push_u<uint8_t>(m,
								m->list.u8,
								val, front);
			case 2:
			...
			case 0:
				CDADA_ASSERT(m->ops);
				return (*m->ops->push)(list, val, front);
			default:
				break;
		}
	}catch(bad_alloc& e){
...
int cdada_list_traverse(const cdada_list_t* list, cdada_list_it f,
	...
	try{
		...
		switch(c){
			case 1:
				cdada_list_traverse_u<uint8_t>(list,
								m->list.u8,
								f, opaque);
				break;
			case 2:
				cdada_list_traverse_u<uint16_t>(list,
								m->list.u16,
								f, opaque);
				break;
			case 4:
				cdada_list_traverse_u<uint32_t>(list,
								m->list.u32,
								f, opaque);
				break;
			case 8:
				cdada_list_traverse_u<uint64_t>(list,
								m->list.u64,
								f, opaque);
				break;
			case 16:
				cdada_list_traverse_u<cdada_u128_t>(list,
								m->list.u128,
								f, opaque);
				break;
			case 32:
				cdada_list_traverse_u<cdada_u256_t>(list,
								m->list.u256,
								f, opaque);
				break;
			case 64:
				cdada_list_traverse_u<cdada_u512_t>(list,
								m->list.u512,
								f, opaque);
				break;
			case 128:
				cdada_list_traverse_u<cdada_u1024_t>(list,
								m->list.u1024,
								f, opaque);
				break;
			case 256:
				cdada_list_traverse_u<cdada_u2048_t>(list,
								m->list.u2048,
								f, opaque);
				break;
			case 0:
				CDADA_ASSERT(m->ops);
				(*m->ops->traverse)(list, f, opaque);
				break;
			default:
				CDADA_ASSERT(0);
				return CDADA_E_UNKNOWN;
...
int cdada_list_rtraverse(const cdada_list_t* list, cdada_list_it f,
	...
	try{
		...
		switch(c){
			case 1:
				cdada_list_rtraverse_u<uint8_t>(list,
								m->list.u8,
								f, opaque);
				break;
			case 2:
				cdada_list_rtraverse_u<uint16_t>(list,
								m->list.u16,
								f, opaque);
				break;
			case 4:
				cdada_list_rtraverse_u<uint32_t>(list,
								m->list.u32,
								f, opaque);
				break;
			case 8:
				cdada_list_rtraverse_u<uint64_t>(list,
								m->list.u64,
								f, opaque);
				break;
			case 16:
				cdada_list_rtraverse_u<cdada_u128_t>(list,
								m->list.u128,
								f, opaque);
				break;
			case 32:
				cdada_list_rtraverse_u<cdada_u256_t>(list,
								m->list.u256,
								f, opaque);
				break;
			case 64:
				cdada_list_rtraverse_u<cdada_u512_t>(list,
								m->list.u512,
								f, opaque);
				break;
			case 128:
				cdada_list_rtraverse_u<cdada_u1024_t>(list,
								m->list.u1024,
								f, opaque);
				break;
			case 256:
				cdada_list_rtraverse_u<cdada_u2048_t>(list,
								m->list.u2048,
								f, opaque);
				break;
			case 0:
				CDADA_ASSERT(m->ops);
				(*m->ops->rtraverse)(list, f, opaque);
				break;
			default:
				CDADA_ASSERT(0);
				return CDADA_E_UNKNOWN;
...
int cdada_list_dump(cdada_list_t* list, uint32_t size, char* buffer,
	...
	try{
		...
		switch(c){
			case 1:
				cdada_list_dump_u<uint8_t>(m,
								m->list.u8,
								ss);
				break;
			case 2:
				cdada_list_dump_u<uint16_t>(m,
								m->list.u16,
								ss);
				break;
			case 4:
				cdada_list_dump_u<uint32_t>(m,
								m->list.u32,
								ss);
				break;
			case 8:
				cdada_list_dump_u<uint64_t>(m,
								m->list.u64,
								ss);
				break;
			case 16:
