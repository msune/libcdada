...
int cdada_set_traverse(const cdada_set_t* set, cdada_set_it f, void* opaque){
	...
	try{
		...
		switch(c){
			case 1:
				cdada_set_traverse_u<uint8_t>(m,
								m->set.u8,
								f,
								opaque);
				break;
			case 2:
				cdada_set_traverse_u<uint16_t>(m,
								m->set.u16,
								f,
								opaque);
				break;
			case 4:
				cdada_set_traverse_u<uint32_t>(m,
								m->set.u32,
								f,
								opaque);
				break;
			case 8:
				cdada_set_traverse_u<uint64_t>(m,
								m->set.u64,
								f,
								opaque);
				break;
...
int cdada_set_rtraverse(const cdada_set_t* set, cdada_set_it f, void* opaque){
	...
	try{
		...
		switch(c){
			case 1:
				cdada_set_rtraverse_u<uint8_t>(m,
								m->set.u8,
								f,
								opaque);
				break;
			case 2:
				cdada_set_rtraverse_u<uint16_t>(m,
								m->set.u16,
								f,
								opaque);
				break;
			case 4:
				cdada_set_rtraverse_u<uint32_t>(m,
								m->set.u32,
								f,
								opaque);
				break;
			case 8:
				cdada_set_rtraverse_u<uint64_t>(m,
								m->set.u64,
								f,
								opaque);
				break;
...
int cdada_set_dump(cdada_set_t* set, uint32_t size, char* buffer,
	...
	try{
		...
		switch(c){
			case 1:
				cdada_set_dump_u<uint8_t>(m, m->set.u8,
								ss);
				break;
			case 2:
			...
			case 8:
				...
				break;
			case 16:
				cdada_set_dump_u<cdada_u128_t>(m, m->set.u128,
								ss);
				break;
			case 32:
				cdada_set_dump_u<cdada_u256_t>(m, m->set.u256,
								ss);
				break;
			case 64:
				cdada_set_dump_u<cdada_u512_t>(m, m->set.u512,
								ss);
				break;
			case 128:
				cdada_set_dump_u<cdada_u1024_t>(m, m->set.u1024,
								ss);
				break;
			case 256:
				cdada_set_dump_u<cdada_u2048_t>(m, m->set.u2048,
								ss);
				break;
			case 0:
				CDADA_ASSERT(m->ops);
